...
class Room extends React.Component
{
		...
		return (
			<Appear duration={300}>
				<div data-component='Room'>
					...
					<div className={this.showself?'f-hide':''} style={{"minHeight":'100vh','-webkit-transform':'rotateY(180deg)'}}>
						<Peers />
					</div>				
					
					<div className={this.showself?'':'f-hide'} style={{"height":'100%'}}>
						<div
	...
	componentDidMount()
	{
		...
		let s = roomClient.getQueryString("self");
		this.showself = Boolean(s);
	}
}
